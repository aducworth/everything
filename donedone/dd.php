...
$domain ="ehousestudio";/* e.g. wearemammoth */
$token ="327FA3EAF53D116D9A5301746ECBB6DE";
$username ="aducworth";
$password ="tigerlover123";
$issueTracker =new IssueTracker($domain, $token, $username, $password);

function formatDate( $date ) {

	return date( 'Y-m-d H:i:s', substr( str_replace( array( '/', 'Date(', ')' ), '', $date ), 0, 10 ) );
